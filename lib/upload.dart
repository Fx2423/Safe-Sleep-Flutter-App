    ...
    Future uploadFile() async {
      ...
      try {
        ...
        alertbox(
            context,
            'Upload Sucessful',
            'Please restart Python Server for the files to Sync',
    ...
    Future imgFromGallery() async {
      setState(() {
        if (pickedFile != null) {
          ...
          alertbox(context, 'No Image Selected', 'Please Upload a File',
              'asset/animation/alerts.gif');
        }
      });
    }
        ...
        child: Column(
          children: <Widget>[
            ...
            Padding(
              ...
              child: Text(
                'Kindly Upload the Image with the name of Person.',
            ...
            Container(
              ...
              child: TextField(
                ...
                decoration: ThemeHelper().textInputDecoration(
                    'Person Name', 'Enter Name of Person in Image'),
              ),
            ...
            Center(
              child: GestureDetector(
                ...
                child: CircleAvatar(
                  radius: 55,
                  backgroundColor: Color.fromARGB(255, 9, 253, 241),
                  child: _photo != null
                      ? ClipRRect(
