                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        color: Color.fromARGB(255, 85, 97, 93),
                            ...
                            Padding(
                              ...
                              child: Text(
                                ...
                                style: GoogleFonts.bebasNeue(
                                  color: Color.fromARGB(255, 241, 255, 250),
                                  fontSize: 28,
                                ),
                              ),
                            ),
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        listItemStats(
                            Icons.trending_up, "Intrusion Line", boo1),
                        listItemStats(
                            Icons.face_outlined, "Face recogntion", boo2),
                        listItemStats(
                            Icons.timelapse_rounded, "Coming Soon", false)
                      ],
                    ),
                  ),
                ],
    ...
    return Container(
      ...
      child: Column(
        children: <Widget>[
          ...
          Icon(i,
              size: 45,
              color: value ? const Color.fromARGB(255, 0, 0, 0) : Colors.white),
          SizedBox(height: 15),
          Text(name,
              style: TextStyle(
                  fontSize: 13,
