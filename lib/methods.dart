...
import 'package:safe_sleep/constants.dart';
import 'package:safe_sleep/home.dart';
import 'package:safe_sleep/skelton.dart';
...
Future<UserCredential?> createAccount(BuildContext context, String email,
    String password, String RSTP, String name) async {
  sucess() async {
    Navigator.of(context).pop();
    alertbox(
        context,
        'Verification Email Sent',
        "Email Verification Sent, Please verify the Email First",
  ...
  try {
    ...
    Map<String, dynamic> g = {
      ...
      "Mode": 1,
      "Intrusion Points":
          "{69.33333333333333: 425.0, 286.6666666666667: 188.0, 295.3333333333333: 528.6666666666666, 77.33333333333333: 419.0}",
    };
...
logout(BuildContext context) async {
  ...
  failure() {
    ...
    alertbox(context, 'Connection Failed',
        'Please Check your Internet Connection', 'images/alerts.gif');
    return null;
  }
...
class GetData {
  final CollectionReference captures = FirebaseFirestore.instance
      .collection('Users')
      .doc(_auth.currentUser!.uid)
      .collection('Captures');
